...
export default function DeleteBorrowing({ isOpen, onClose, onConfirm, equipmentName, userName }) {
        ...
        <div className="fixed inset-0 flex items-center justify-center z-50 bg-black/30">
            <div className="bg-white rounded-lg shadow-xl w-80 max-w-[90%] p-6 pointer-events-auto">
                ...
                <p className="text-gray-700 mb-6">
                    {t('areYouSureDeleteBorrowing')} <strong>{equipmentName}</strong> {t('by')} <strong>{userName}</strong>?
                </p>
